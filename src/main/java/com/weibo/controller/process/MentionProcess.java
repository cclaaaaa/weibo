...
public class MentionProcess {
	 ...
	 * @return
	 */
	public String toRepostPage(HttpSession session, Model model, int pageNo) {
	 ...
	 * @param pageNo
	 */
	public String toCommentPage(HttpSession session, Model model, int pageNo) {
	 ...
	 * @return
	 */
	public String toReplyPage(HttpSession session, Model model, int pageNo) {
	 ...
	 * @throws Exception
	 */
	public String toLikePage(HttpSession session, Model model, int pageNo) {
	 ...
	 * @return
	 */
	public String toMyLikes(HttpSession session, Model model, int pageNo) {
	 ...
	 * @return
	 */
	public String toMyCollection(HttpSession session, Model model, int pageNo) {
		UserCustom user = (UserCustom) session.getAttribute("user");
