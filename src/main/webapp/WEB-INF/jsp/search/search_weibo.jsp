	...
	<c:forEach items="${weiboList }" var="weibo" varStatus="status">
		...
		<div class="container" style="width: 850px; background-color: #fff;">
			...
			<div class="btn-group" style="width: 100%">
				<button type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-file"></span>收藏</button>
				<button type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-share"></span> 转发</button>
				<button onclick="javascript:loadComment(${weibo.weiboId});" type="button" style="width: 20%;margin-right:8px; color:#958d8f;" 
					class="btn btn-md" id="bt${status.index }"><span class="glyphicon glyphicon-comment"></span> 评论</button>
				<button type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-heart-empty"></span> 点赞</button>
			</div>
			<br> <br>
		</div>
		<!-- 评论区 -->
