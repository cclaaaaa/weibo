						...
						<div class="btn-group" style="width: 100%">
							...
							<c:if test="${collection.weibo.collect==0 }">
								<button id="collect${collection.weibo.weiboId }"
									...
									type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-file"></span>收藏</button>
							</c:if>
							<c:if test="${collection.weibo.collect==1 }">
								<button id="collect${collection.weibo.weiboId }"
									onclick="javascript:collect(${collection.weibo.weiboId});"
									type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-file"></span>已收藏</button>
							</c:if>
							<!------------------------------------------------------------------------------------------------------------------->
							<button type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"
								onclick="javascript:repost(${collection.weibo.weiboId});"><span class="glyphicon glyphicon-share"></span> 转发</button>
							<button
								...
								id="bt${status.index }"><span class="glyphicon glyphicon-comment"></span> 评论</button>
							<!---------------------------------------------------- 点赞 --------------------------------------------------------->
							<c:if test="${collection.weibo.likes==0 }">
								<button id="like${collection.weibo.weiboId}" type="button"
									style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"
