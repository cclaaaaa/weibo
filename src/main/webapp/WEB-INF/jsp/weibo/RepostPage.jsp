...
<button id="collect${weibo.weiboId }" onclick="javascript:collect(${weibo.weiboId});" type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-file"></span>收藏</button>
</c:if>
<c:if test="${weibo.collect==1 }">
<button id="collect${weibo.weiboId }" onclick="javascript:collect(${weibo.weiboId});" type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md"><span class="glyphicon glyphicon-file"></span>已收藏</button>
</c:if>
<!------------------------------------------------------------------------------------------------------------------->
...
<button onclick="javascript:loadComment(${weibo.weiboId});" type="button" style="width: 20%;margin-right:8px; color:#958d8f;"
	class="btn btn-md" id="bt${status.index }"><span class="glyphicon glyphicon-comment" aria-hidden="true">></span>评论</button>
<!---------------------------------------------------- 点赞 --------------------------------------------------------->
<c:if test="${weibo.likes==0 }">
<button id="like${weibo.weiboId}" type="button" style="width: 20%;margin-right:8px; color:#958d8f;" class="btn btn-md" onclick="javascript:likes(${weibo.weiboId})">
