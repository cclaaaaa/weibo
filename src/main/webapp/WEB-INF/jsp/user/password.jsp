    ...
    <div class="cover-container" style="margin-left: 160x;">
        <form class="form-horizontal" action="${pageContext.request.contextPath }/updatePassword.action" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="oldPassword" type="password" class="form-control" style="width: 68%">
                </div>
            </div>
            <br>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="newPassword" name="newPassword" type="password" class="form-control" style="width: 68%">
                </div>
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input oninput="javascript:check_password();" name="rePassword" id="rePassword" type="password" class="form-control" style="width: 68%">
                </div>
            </div>
            <br>
            <br>
