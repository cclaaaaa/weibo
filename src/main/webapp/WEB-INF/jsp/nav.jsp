...
<script type="text/javascript">
	...
	function search_weibo() {
		...
		if (key == "") {
			...
			document.write("<form action='${pageContext.request.contextPath }/queryWeiboByWord.action' method=post name=form1 style='display:none'>");
		    document.write("<input type=hidden name=key value='"+key+"'/>");
		    document.write("<input type=hidden name=pageNo value='1'/>");
		    document.write("</form>");
	...
	function search_people() {
		...
		if (key == "") {
			...
			document.write("<form action='${pageContext.request.contextPath }/queryUserBySimpleName.action' method=post name=form1 style='display:none'>");
		    document.write("<input type=hidden name=key value='"+key+"'/>");
		    document.write("</form>");
		    document.form1.submit();
		}
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="skipToResetPassword.action">修改密码</a></li>
